...
function(startGame) {
  ...
  game.questionBox = game.currentQuestion.question;
  ...
  $(ui.button).on('click', function() {
    ...
    if (game.currentQuestionId >= (content.length - 1)) {
      ...
      var usersAnswer = $(ui.answer).val(); // .val() gets text from a user input
      ...
      showQuestion: function showQuestion(homeQ){}
